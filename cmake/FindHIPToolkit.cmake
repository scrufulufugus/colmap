...
if( NOT TARGET HIP::hiprt )
   add_library( HIP::hiprt IMPORTED INTERFACE )
   target_include_directories( HIP::hiprt
      SYSTEM INTERFACE "${HIP_INCLUDE_DIRS}" )
   target_link_libraries( HIP::hiprt INTERFACE "${HIP_LIBRARIES}" )
   target_compile_definitions( HIP::hiprt INTERFACE "${HIP_DEFINITIONS}" )
endif()
if( NOT TARGET HIP::rocrand )
   add_library( HIP::rocrand IMPORTED INTERFACE )
   target_include_directories( HIP::rocrand
      SYSTEM INTERFACE "${HIP_INCLUDE_DIRS}" )
   target_link_libraries( HIP::rocrand INTERFACE "${HIP_LIBRARIES}" )
   target_compile_definitions( HIP::rocrand INTERFACE "${HIP_DEFINITIONS}" )
endif()
